...
/**
 * Lance une partie de jeux donnée et affiche le résultat
 */
    ...
    public static void main(String[] args) {
        ...
        ArgParse.setUsage
                ("""
                        ...
                        -game : Le nom du jeux {tictactoe, connect4, gomoku, mnk}. Par défaut tictactoe
                        -p1/2 : L'algorithme joueur {random, human, minmax, alphabeta}. Par défaut rnd pour les deux
